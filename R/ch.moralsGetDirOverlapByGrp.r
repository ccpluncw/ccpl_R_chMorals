...
#' @param grpCol a string the specifies the column name in "data" that contains the grouping column.
...
ch.moralsGetDirOverlapByGrp <- function (data, probe1Col, grpCol, dirOverlapCol) {
